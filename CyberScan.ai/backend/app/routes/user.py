...
async def test_email(current_user: User = Depends(get_current_user)):
    ...
    result = {
        ...
        "brevo_key_prefix": settings.BREVO_API_KEY[:12] if settings.BREVO_API_KEY else "MISSING",
    ...
    try:
        ...
        class FakeScan:
            ...
            overall_severity = "medium"; summary = "Test"
            vulnerabilities = []; raw_findings = []; ssl_valid = True
